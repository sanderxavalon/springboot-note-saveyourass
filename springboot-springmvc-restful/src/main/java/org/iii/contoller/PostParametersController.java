...
public class PostParametersController {

    // 1. HttpServletRequest直接拿參數
    @RequestMapping(path = "/OldFashionWay", method = RequestMethod.POST)
    ...
    // 順序無關，如果無參嘖null
    @RequestMapping(path = "/getParamsWithoutAnnotation", method = RequestMethod.POST)
